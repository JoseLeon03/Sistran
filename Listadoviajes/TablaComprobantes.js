...
function tablasComprobante(contenedor2,numeroComprobante , id_viaje){
    function llenarTablaComprobantes(idViaje) {
      consultar.connect().then(() => {
        ...
        request.query(`
          SELECT Num_comprobante, Descripcion, format ( Fecha, 'dd/MM/yyyy') as Fecha, Monto, Beneficiario from Comprobante_viajes WHERE Codigo_viaje= ${idViaje}; 
        `).then((result) => {
              ...
              td.addEventListener('click', () => {
                ...
                const modificarComprobantes = `
                    ...
                    <div class="emergente_btn"> 
                      <button type="button" id="Anular" class="redButton"> Anular comprobante</button>  
                  ...
                  // El usuario hizo clic en "no"
                      ...
                      try {
                        ...
                        const sqlQuery = `
                          ...
                          SET Descripcion = '${descripcion}', Fecha = '${fecha}', Monto = ${monto}
